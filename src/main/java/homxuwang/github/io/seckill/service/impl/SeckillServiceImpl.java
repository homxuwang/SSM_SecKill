package homxuwang.github.io.seckill.service.impl;

import homxuwang.github.io.seckill.dao.SeckillDao;
import homxuwang.github.io.seckill.dao.SuccessKilledDao;
...
import homxuwang.github.io.seckill.enums.SeckillStateEnum;
...
import homxuwang.github.io.seckill.service.SeckillService;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    //md5的盐值字符串，用于混淆MD5
    private final String slat = "djskaljfdiao$U()J)$(0TJ430:ldkjKFJIOjd";
     ...
     * 2:保证事务方法的执行时间尽可能短,不要穿插其他的网络操作，RPC/HTTP请求或者剥离到事务方法外面
     * 3:不是所有的方法都需要事务,比如只读操作或者只有一条修改操作不需要事务控制.
     *
     */
